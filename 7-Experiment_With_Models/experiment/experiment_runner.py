...
def create_clean_results_csv():
    ...
    with open(results_path, mode='w', newline='') as f:
        ...
        f.write('model,precision_macro,recall_macro,f1_macro,roc_auc,best_params,status,f1_external,precision_c1,recall_c2,f1_c0,custom_score,false_alarm_rate,missed_threat_rate,final_alpha,per_class_f1\n')
